...
class PdfWriter{
    ...
    async getPdfBuffer(htmlContentOrUrl, isRelUrl, pdfOptions={}, serverOptions={}){
        ...
        let page = await this.ppt.newPage();
        ...
        // apply target-specific serverOptions atop server options
        ...
        // apply target-specific pdfOptions atop server options
        let _pdfOptions = Object.assign({}, this._pdfOptions, pdfOptions)
